# UNESCO GLOBAL YOUTH HACKATHON 2026: SUBMISSION PORTAL CHEAT SHEET

Use this quick-reference guide when filling out the official UNESCO submission forms.

---

## 1. Core Submission Form Fields

* **Official Project Title:**  
  `VeriVoice: Voice-Driven AI & Media Literacy Engine`
* **Short Project Tagline (3 Words):**  
  `Voice. Verify. Empower.`
* **Core Extended Tagline:**  
  `Empowering the next generation to talk back to misinformation.`
* **The One-Sentence Master Pitch Summary:**  
...
* **Strategic Focus Areas:**  
  `AI and MIL | MIL Education | Community Impact | Oral-First Inclusion`
* **Strategic Category / Modality:**  
  `Specialized Web-Verification Platform, Trust Nodes Network & Native Audio Stream`
* **Target Focus Domains:**  
  `Public Health, AI & Deepfakes, Climate & Weather, Emergency Disasters, Science, Policy & Media Information Literacy (MIL)`
* **Supported Languages:**  
  `Urdu (اردو), Indonesian (Bahasa Indonesia), Spanish (Español), English`
* **Primary Target Audience / Beneficiaries:**  
  `Young users (ages 8–17) navigating algorithmic feeds and AI tools; underserved rural and semi-urban communities with oral-first literacy; community health workers and local educators in South Asia, Latin America, and Southeast Asia.`
...
* **Open-Source GitHub Repository:**  
  `https://github.com/HamzaKhanBUIC/Veri-Voice-Unesco-Hackathon`
...
## 4. Evaluation Matrix Alignment Summary (For Short Answers)

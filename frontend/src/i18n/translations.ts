...
export const translations: Record<LanguageCode, TranslationSchema> = {
  en: {
    ...
    hero: {
      tagline: 'UNESCO #GlobalMILWeek2026 · Voice-First Media Literacy Platform',
      headline: 'Voice. Verify. Empower.',
      subheadline:
        'When viral rumors spread through 30-second voice notes across community chats, text-heavy fact-checking fails. VeriVoice empowers communities to speak any claim across 12 domains in Urdu, Indonesian, Spanish, or English—and receive instant, high-definition spoken answers verified directly against primary institutional archives (WHO, NASA, IPCC, UNESCO).',
      startTalk: 'Start Voice Talk',
      searchResearch: 'Search & Citations',
      discordBot: 'Discord Bot',
    },
    quickStart: {
      badge: 'UNESCO MIL Operational Pipeline',
      title: 'Voice Truth Forward in Three Steps',
      step1Tag: '01 · ACCESS · Spoken Audio Input',
      step1Title: 'Voice In, No Reading Barrier',
      step1Desc:
        'Tap the Acoustic Core and speak naturally in Urdu, Indonesian, Spanish, or English. Groq Whisper ASR transcribes regional dialects with zero delay.',
      step1Btn: 'Open Talk Mode',
      step2Tag: '02 · ANALYZE · 12-Domain Consensus',
      step2Title: 'Institutional Archives Over Clickbait',
      step2Desc:
        'Cross-examines claims across WHO, NOAA, NASA, and USGS registries. If evidence is missing, the engine admits uncertainty rather than hallucinating.',
      step2Btn: 'Open Chat & Evidence',
      step3Tag: '03 · ACT · Spoken Truth & Citations',
      step3Title: 'Listen & Share Verified Audio Cards',
      step3Desc:
        'Hear high-definition neural spoken explanations (ElevenLabs & Edge-TTS) and forward verified audio cards directly back into community group chats.',
